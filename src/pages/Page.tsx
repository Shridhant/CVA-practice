        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20 dark:text-gray-300 dark:ring-gray-300/10 dark:hover:ring-gray-300/20">
              We have a lot of new and exciting news!.{" "}
              <a
                href="#"
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-6xl">
              Transforming Your Way Of Building UI Libraries
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
              Boilter plate to writing your own UI Library for any app you wish
              to add it to!
            </p>
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between py-2">
        <div className="inline-flex items-center space-x-2">
          ...
          <p className="text-base">
            <span className="font-bold">Reel</span>
            Deal
          </p>
        </div>
        ...
        <div className="hidden lg:block">
          <button className="group relative mt-3">
              ...
              <div className="px-5 pb-6 pt-5">
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center space-x-2">
                    ...
                    <span className="font-bold">Reel-Deal</span>
                  </div>
                  <div className="-mr-2">
                    <button
                      type="button"
